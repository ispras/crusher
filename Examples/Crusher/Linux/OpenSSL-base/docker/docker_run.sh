...
cmd="docker run --rm --privileged --network host -e LANG=C.UTF-8 -e LC_ALL=C.UTF-8 -w $test_dir -v $crusher_dir:/opt/crusher -v $test_dir:$test_dir $hasp_ip_env -ti openssl-fuzz:latest /bin/bash"
echo "$cmd"
$cmd
