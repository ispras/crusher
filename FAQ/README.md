...
Где ИМЯ_ДОКЕРФАЙЛА это выбранный пример докерфайла, ИМЯ_ОБРАЗА - произвольное, назначаемое экспериментирующим, имя образа, а ИМЯ_КОНТЕЙНЕРА - произвольное, назначаемое экспериментирующим имя контейнера.
