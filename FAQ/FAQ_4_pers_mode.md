...
Обратите внимание на ключ -D - этим ключем в препроцесоор компилятора можно подать макросы непосредственно в командной строке компилятора (объявить макросы в модуле трансшяции, поданном в компилятор), что собственно здесь и происходит.   
...
1. В варианте под линукс функция, которую мы хотим фаззить, находится в анонимном нэймспейсе внутри именнованного нэймспейса.
...
1. Все анонимные неймспейсы одного уровня в одном модуле трансляции склеиваются. Обращаться к ним можно в этом файле из родительского именнованного неймспейса напрямую.
