...
*Пользователь, от которого выполняются команды должен иметь права root или быть добавлен в группу docker, подробнее https://docs.docker.com/engine/install/linux-postinstall/
